...
public class ControlStarter implements StarterAPI<BattleObjectiveAPI> {

	@Override
	public List<BattleObjectiveAPI> getInitialTargets(ShipAPI source, CombatEngineAPI engine) {
		return AutomationUtils.getAlliesObjectiveOnMap(source);
	}

	@Override
	public CombatAssignmentType getCombatAssignmentType() {
		return CombatAssignmentType.CONTROL;
	}
}
